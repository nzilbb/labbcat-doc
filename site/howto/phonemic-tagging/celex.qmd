...
CELEX is essentially a lexical database, available in English, German, and Dutch (although the Dutch database is not yet supported by LaBB-CAT).  You can purchase the database from the 
