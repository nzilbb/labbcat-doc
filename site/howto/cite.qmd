...
@InProceedings{FromontHay2012,
  ...
  url = {https://figshare.canterbury.ac.nz/articles/journal_contribution/LaBB-CAT_an_Annotation_Store/32248143}
}
```
...
[Robert Fromont, Lynn Clark, Joshua Wilson Black, & Margaret Blackwood (2023)](https://ldr.lps.library.cmu.edu/article/id/672/)
*Maximizing accuracy of forced alignment for spontaneous child speech*,
Language Development Research, Volume 3, Issue 1, 2023,
...
Version [20260714](https://sourceforge.net/projects/labbcat/files/install/labbcat-server_20260714.zip)

```
@Misc{labbcat20260714,
  author = {Robert Fromont},
  title = {LaBB-CAT: linguistic annotation system [Computer program]},
  howpublished = {{https://sourceforge.net/projects/labbcat/files/install/labbcat-server_20260714.zip}}
  year = {2026}
}
```

Version [20251105](https://sourceforge.net/projects/labbcat/files/install/labbcat-server_20251105.zip)

```
@Misc{labbcat20251105,
  author = {Robert Fromont},
  title = {LaBB-CAT: linguistic annotation system [Computer program]},
  howpublished = {{https://sourceforge.net/projects/labbcat/files/install/labbcat-server_20251105.zip}}
  year = {2025}
}
```

Version [20250819](https://sourceforge.net/projects/labbcat/files/install/labbcat-server_20250819.zip)
...
Version [20250430](https://sourceforge.net/projects/labbcat/files/install/labbcat-server_20250430.zip)
