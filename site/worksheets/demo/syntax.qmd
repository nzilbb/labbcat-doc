...
1.  Untick the *parseable* layer and tick the *pos* layer.\
    ...
    -   \...etc.\
        ...
        each utterance.
2.  Untick the *pos* layer (and the *language* layer if it\'s ticked)
...
8.  Enter a pattern that matches *NP* (noun phrase) on the *parse*
    layer...
