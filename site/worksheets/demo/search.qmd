...
Layered search is a two-step process: first you select which
...
2.  Click 'M' in the *Gender* box. \
    ...
    of them, so leave all the boxes ticked.)
...
1.  In the box labelled *Tick layers to include*, there\'s a *Projects*
...
4.  Unlike the *orthography* layer, which has one box for a regular
    ...
    **Tip**: ensure the orthography box is empty, otherwise it will be
