...
2.  For the *Word Count* attribute, there are two boxes which you can
    ...
    each participant.
3.  Click the *participants* link on the menu.
...
1.  On the *transcripts* page, list the transcripts with the *Quake
...
1.  Click the *home* link on the menu.
...
-   the Statistics Layer Manager can provide a variety of summary
    computations,
-   the transcript list can be filtered and sorted by transcript
    attributes,
...
-   personality metrics can be obtained for participants, based on their
    utterances.
:::
