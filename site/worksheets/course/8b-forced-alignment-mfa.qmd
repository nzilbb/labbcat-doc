...
:::{.callout-note}
<!-- After saving the layer, the MFA configuration form will appear. -->
...
(@) On the *Layers* tab, tick both the *mfa* layer and the *segment* layer.\
...
(@) If you click on a word, and hit the {{< kbd tab >}} key, the word's
    ...
    about how accurate MFA has been with its alignment.\
    ...
    can figure out why MFA got it wrong.\
...
improvements, because MFA will never change them again.
:::
