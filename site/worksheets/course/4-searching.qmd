...
For example, if the last time you accessed the *participants* page, you selected the `CC` corpus to show only *CC* participants, that filter may still be active. To remove that filter, just press `CC` again to de-select that option.
:::
