...
(@) Click on the word "Febuary", and select the *Edit Transcript* option
    from the menu.\
    A text box will appear that allows you to edit that line in the
    transcript.
(@) Correct the spelling of the word to be "February"
(@) Press the save button to the right of the text box ![](save-token.png).\
    After a short delay, the transcript will re-load, and you will see that
    the corrected word now has a pronunciation.
...
(@) Scroll to the top of the transcript, open the *Layers* tab
    and tick the *pronounce* layer so that it will be displayed.\
