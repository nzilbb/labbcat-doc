...
(@) Save and open the resulting CSV file.\
    ...
    -   *frequency:* this contains a single frequency, in this
...
For the last step, you will need to match against two layers at once.

To do that, you need to tick both layers, and fill in the boxes as appropriate 
for matching annotations on each layer.
...
(@) Scroll to the top of the transcript, select the *Participants* tab, 
    and click the *Attributes* link for the main participant.\
